...
@Component
public class ProjectComposer implements DataComposerAdapter<CppProjectTemplate> {
    ...
    @Override
    public CppProjectTemplate compose(String cppFileName, String projectGuild) {
